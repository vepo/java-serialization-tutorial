...
public class SimpleJsonObject {
    ...
    public SimpleJsonObject(String field1, int field2, Integer field3, BigDecimal field4) {
        ...
        this.field3 = field3;
        this.field4 = field4;
        this.transientField = this.field1 + " - " + this.field2 + " - " + this.field3 + " - field4";
    }
    ...
    public boolean equals(Object obj) {
        ...
        SimpleJsonObject other = (SimpleJsonObject) obj;
    ...
    public String toString() {
        return String.format("SimpleJsonObject [field1=%s, field2=%s, field3=%s, field4=%s, transientField=%s]", field1,
